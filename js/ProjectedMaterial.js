...
const monkeyPatch = (shader, { header = '', main = '', ...replaces }) => {
...
// scale to keep the image proportions and apply textureScale
const computeScaledDimensions = (texture, camera, textureScale, cover, width, height) => {
  //console.log(texture.image);
  const ratio = width/height;//1960/1225;//968/645;//1400/737;//1200/675;//1860/1158;//1000/563;//texture.image.width / texture.image.height;
  console.log(ratio);
...
export const projectInstanceAt = (index, instancedMesh, matrixWorld) => {
...
export const allocateProjectionData = (geometry, instancesCount) => {
